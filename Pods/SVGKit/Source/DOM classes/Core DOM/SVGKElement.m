...
{
	SVGKAttr* att = [[SVGKAttr alloc] initWithName:name value:value];
...
{
	SVGKNodeList* accumulator = [[SVGKNodeList alloc] init];
...
{
	SVGKAttr* att = [[SVGKAttr alloc] initWithNamespace:namespaceURI qualifiedName:qualifiedName value:value];
